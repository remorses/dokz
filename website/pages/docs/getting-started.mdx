...
The markdown extension used is `mdx`, it has all the markdonw features plus you can import, export and render react components 🔥
...
```bash
npm install dokz @emotion/core @chakra-ui/core
# or
